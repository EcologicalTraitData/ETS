...
In addition to the mere listing of trait definitions, a trait 'ontology' would be providing a formal model of the conceptual objects and relationships, or entities and qualities [@garnier17, @gruber95], ideally structured following the guidelines for a semantic web standard [@berners-lee02]. This can take rather complex forms, but for trait data might be just adding a hierarchy of broader and narrower terms. 
...
If the trait thesaurus is developed with a broader scope and
